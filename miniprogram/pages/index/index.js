...
var myPluginInterface = _index2.default.requirePlugin('myPlugin');
...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.config = {
      ...
      _index2.default.scanCode().then(function (json) {
        var appkey = json.result.split('=')[2];
        console.log(appkey);
        if (appkey) {
  ...
  return Index;
}(_index.Component), _class.$$events = ["handleClick"], _class.$$componentPath = "pages/index/index", _temp2);
